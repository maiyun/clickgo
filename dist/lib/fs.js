...
const clickgoFiles = ['/app/', '/app/demo.cga', '/app/task.cga', '/control/', '/control/arteditor.cgc', '/control/box.cgc', '/control/captcha.cgc', '/control/common.cgc', '/control/cube.cgc', '/control/desc.cgc', '/control/drawer.cgc', '/control/echarts.cgc', '/control/fabric.cgc', '/control/form.cgc', '/control/iconview.cgc', '/control/jodit.cgc', '/control/konva.cgc', '/control/map.cgc', '/control/marked.cgc', '/control/monaco.cgc', '/control/mpegts.cgc', '/control/nav.cgc', '/control/novnc.cgc', '/control/objviewer.cgc', '/control/page.cgc', '/control/pdf.cgc', '/control/property.cgc', '/control/qrcode.cgc', '/control/sform.cgc', '/control/swiper.cgc', '/control/table.cgc', '/control/task.cgc', '/control/tplink.cgc', '/control/tuieditor.cgc', '/control/tuiviewer.cgc', '/control/tums.cgc', '/control/waterfall.cgc', '/control/web.cgc', '/control/xterm.cgc', '/ext/', '/ext/toastui-editor-all.min.js', '/ext/tplinkhd.min.js', '/ext/tums-player/', '/ext/tums-player/audio.wasm', '/ext/tums-player/decoder.worker.js', '/ext/tums-player/libaudio.js', '/ext/tums-player/libaudio.wasm', '/ext/tums-player/libffmpeg.js', '/ext/tums-player/libffmpeg.wasm', '/ext/tums-player/libs.worker.js', '/ext/tums-player/tums-player.umd.min.js', '/ext/tums-player/webgl.js', '/ext/tums-player/webgl.worker.js', '/global.css', '/icon.png', '/index.js', '/notosans-regular.ttf', '/theme/', '/theme/admin.cgt', '/theme/cyber.cgt', '/theme/dark.cgt', '/theme/light.cgt', '/theme/modern-light.cgt', '/theme/modern.cgt'];
/** --- fs lib 用到的语言包 --- */
const localeData = {
    'en': {
