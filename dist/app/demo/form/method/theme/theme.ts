...
export default class extends clickgo.form.AbstractForm {
    ...
    public async get(name: 'dark' | 'light' | 'cyber' | 'admin' | 'modern'): Promise<clickgo.theme.ITheme | null> {
    ...
    public async setGlobal(name: 'dark' | 'light' | 'cyber' | 'admin' | 'modern'): Promise<void> {
        const n = clickgo.form.notify({
            'title': 'Info',
            'content': 'Theme loading...',
            'type': 'info'
