import type { IHistoryState, TToolId } from '../model';
import type { IDrawTool, IPoint } from './tool';
...
export default class {
    ...
    /** --- 工具注册表 --- */
    private readonly _tools = new Map<TToolId, IDrawTool>();

    /** --- 撤销重做历史 --- */
    private readonly _history = new CommandHistory();

    /** --- 当前工具 --- */
    private _activeTool: IDrawTool | null = null;

    /** --- 当前是否正在绘制 --- */
    private _drawing = false;

    /** --- 当前笔画绘制前快照 --- */
    private _before: ImageData | null = null;
    ...
    public constructor(
        ...
        private readonly _onHistoryChange: (state: IHistoryState) => void
    ) {
     ...
     * @param tools 工具列表
     */
    public register(...tools: IDrawTool[]): void {
     ...
     * @param id 工具 ID
     */
    public activate(id: TToolId): void {
