...
export class ArtboardModule {
    ...
    get artboardBeforeRender() {
        return this._host.artboardBeforeRender;
    }
    set artboardBeforeRender(value) {
    ...
    artboardApplyObjClip(obj) {
        ...
        if (clipPath && lLayer.getName(clipPath) === ARTBOARD_CLIP_NAME) {
            ...
            clipRect.name = ARTBOARD_CLIP_NAME;
    ...
    artboardApply() {
        ...
        if (artboardWidth === 0 || artboardHeight === 0) {
            ...
            canvas.forEachObject(obj => {
                if (obj.clipPath && lLayer.getName(obj.clipPath) === ARTBOARD_CLIP_NAME) {
