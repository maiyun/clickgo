...
export class MarqueeModule implements IMarqueeModule {
        ...
        if (this._isMarqueeMoving) {
            ...
            if (dx !== 0 || dy !== 0) {
                ...
                if (this._artboard) {
                    ...
                    cdx = Math.max(this._artboard.left - minX,
                        Math.min(cdx, this._artboard.left + this._artboard.width - maxX));
                    cdy = Math.max(this._artboard.top - minY,
                        Math.min(cdy, this._artboard.top + this._artboard.height - maxY));
                }
...
export interface IMarqueeModule {
