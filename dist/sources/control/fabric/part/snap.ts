...
export function snapMixin<
    TBase extends TConstructor<clickgo.control.AbstractControl>
>(base: TBase): TBase & TConstructor<ISnapMixin> {

    abstract class Mixed extends (base as unknown as TConstructor) implements ISnapMixin {
         ...
         */
        public snapApply(target: any, rawLeft?: number, rawTop?: number): void {
    ...
    return Mixed as unknown as TBase & TConstructor<ISnapMixin>;
}
...
export interface ISnapMixin {
     ...
     * @param rawTop 原始 top 坐标
     */
    snapApply(target: any, rawLeft?: number, rawTop?: number): void;
